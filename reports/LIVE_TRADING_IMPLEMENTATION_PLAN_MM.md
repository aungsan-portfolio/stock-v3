...
| 5.2 Startup reconciliation (H18) | `main.py:899-931`, `risk_state.py` | startup တိုင်း `positions()` + `reqAllOpenOrders()` + `executions()` နဲ့ state rebuild; **broker = source of truth**; unprotected-position scan + alert |
