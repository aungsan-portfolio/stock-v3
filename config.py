...
SCAN_MIN_AVG_DAILY_VOLUME = 750_000
SCAN_PREMARKET_MAX_SPREAD_PCT = 0.015  # 1.5% max spread in premarket
SCAN_REGULAR_MAX_SPREAD_PCT   = 0.005  # 0.5% max spread in regular session
